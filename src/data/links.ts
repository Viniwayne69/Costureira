...
export const navigationCards: HazelinkItem[] = [
  {
    id: "course",
    title: "Comprar curso",
    description: "Acesse a página do curso e garanta sua vaga",
    href: linkTargets.course,
    variant: "pink",
    ariaLabel: "Comprar o curso de corte e costura da VM",
  },
  {
    id: "whatsapp",
    title: "Grupo do WhatsApp",
    description: "Entre na comunidade e receba avisos",
    href: linkTargets.whatsapp,
    variant: "white",
    ariaLabel: "Entrar no grupo do WhatsApp do curso da VM",
  },
  {
    id: "instagram",
    title: "Instagram",
    description: "Veja bastidores, alunas e inspirações",
  ...
  },
  {
    id: "location",
    title: "Localização",
    description: "Encontre a VM no Google Maps",
